...
def home(request):
    ...
    if query:
        ...
        search_results = StudyMaterial.objects.filter(title__icontains=query) | StudyMaterial.objects.filter(description__icontains=query) # TODO: готов сервер с Elasticsearch и индексация осталось прикрутить его суда
